...
import { Check, Loader2, X, KeyRound, Mail, LogIn, LogOut } from 'lucide-react';
          ...
          {wallet.authType === 'google' ? (
            <div className="flex flex-col gap-3 bg-[#13131A] p-4 border border-[#1F1F23] rounded-2xl">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-violet-600 to-indigo-600 flex items-center justify-center font-bold text-white text-sm border border-violet-500/30 shadow-lg shadow-violet-500/10">
                    {wallet.email?.charAt(0).toUpperCase() || 'G'}
                  </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-xs font-bold text-white truncate">
                    {wallet.email?.split('@')[0] || 'Jay'}
                  </div>
                  <div className="text-[10px] text-[#71717A] font-semibold truncate">
                    {wallet.email || 'jay@example.com'}
                  </div>
                </div>
              </div>

              <div className="p-2.5 bg-[#0F0F12] border border-[#1F1F23] rounded-xl flex items-center justify-between">
                <span className="text-[9px] font-mono text-[#52525B] font-bold uppercase tracking-wider">
                  Embedded Wallet
                </span>
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="p-1 hover:bg-[#1C1C22] rounded transition-colors text-[#52525B] hover:text-white"
                    title="Copy Address"
                  >
              ...
              <button
                ...
                className="w-full h-10 border border-red-500/20 hover:border-red-500/40 bg-red-950/5 hover:bg-red-950/15 text-red-400 rounded-xl font-bold text-xs tracking-tight transition-all flex items-center justify-center gap-1.5 active:scale-98"
              >
            ...
            <div className="flex flex-col gap-2">
              ...
              <button
                ...
                className="w-full h-12 bg-[#13131A] hover:bg-[#1C1C22] text-white border border-[#1F1F23] hover:border-[#2D2D35] rounded-xl font-bold text-sm tracking-tight transition-all flex items-center justify-center gap-2.5 active:scale-98 shadow-lg shadow-black/25"
              >
